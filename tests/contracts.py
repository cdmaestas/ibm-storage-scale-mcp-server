...
CONTRACTS = [
    ...
    C(
        ...
        "GET",
        "/scalemgmt/v2/cluster/filesystems/{filesystem}/health/state",
    ),
    C(
        "v2.filesystems",
        "get_filesystem_health_events_api",
        {"filesystem_name": "test-filesystem-name"},
        "GET",
        "/scalemgmt/v2/cluster/filesystems/{filesystem_name}/health/events",
    ),
    # --- v2/nodes ---
    C(
        "v2.nodes",
    ...
    C(
        ...
        {"filesystem": "test-filesystem"},
        "GET",
        "/scalemgmt/v3/filesystems/{filesystem}/filesets/afm/state",
    ),
    C(
        "v3.afm",
        "get_afm_state_api",
        {"filesystem": "test-filesystem", "fileset": "test-fileset"},
        "GET",
        "/scalemgmt/v3/filesystems/{filesystem}/filesets/{fileset}/afm/state",
    ),
    C(
        "v3.afm",
        "check_afm_dirty_api",
        {"filesystem": "test-filesystem", "fileset": "test-fileset"},
        "GET",
        "/scalemgmt/v3/filesystems/{filesystem}/filesets/{fileset}/afm/checkdirty",
    ),
    C(
        "v3.afm",
        ...
        {"filesystem": "test-filesystem", "fileset": "test-fileset"},
        "GET",
        "/scalemgmt/v3/filesystems/{filesystem}/filesets/{fileset}/afm/checkuncached",
    ),
    C(
        "v3.afm",
        "flush_afm_queue_api",
        {"filesystem": "test-filesystem", "fileset": "test-fileset"},
        "POST",
        "/scalemgmt/v3/filesystems/{filesystem}/filesets/{fileset}/afm/flushqueue",
    ),
    C(
        "v3.afm",
        ...
        {"filesystem": "test-filesystem", "fileset": "test-fileset"},
        "POST",
        "/scalemgmt/v3/filesystems/{filesystem}/filesets/{fileset}/afm/resumerequeued",
    ),
    C(
        "v3.afm",
        ...
        {"filesystem": "test-filesystem", "fileset": "test-fileset"},
        "POST",
        "/scalemgmt/v3/filesystems/{filesystem}/filesets/{fileset}/afm/resync",
    ),
    C(
        "v3.afm",
        ...
        {"filesystem": "test-filesystem", "fileset": "test-fileset"},
        "POST",
        "/scalemgmt/v3/filesystems/{filesystem}/filesets/{fileset}/afm:start",
    ),
    C(
        "v3.afm",
        ...
        {"filesystem": "test-filesystem", "fileset": "test-fileset"},
        "POST",
        "/scalemgmt/v3/filesystems/{filesystem}/filesets/{fileset}/afm:stop",
    ),
    C(
        "v3.afm",
        "reset_afm_local_api",
        {"filesystem": "test-filesystem", "fileset": "test-fileset", "file_path": "test-file-path"},
        "PATCH",
        "/scalemgmt/v3/filesystems/{filesystem}/filesets/{fileset}/afm:resetlocal",
    ),
    C(
        "v3.afm",
        "set_afm_local_api",
        {"filesystem": "test-filesystem", "fileset": "test-fileset", "file_path": "test-file-path"},
        "PATCH",
        "/scalemgmt/v3/filesystems/{filesystem}/filesets/{fileset}/afm:setlocal",
    ),
    # --- v3/afmcos ---
    C(
        "v3.afmcos",
        ...
        "GET",
        "/scalemgmt/v3/buckets/{bucket_name}/afmcos/getcoskeys",
    ),
    C(
        "v3.afmcos",
        "set_cos_keys_api",
        {"bucket_name": "test-bucket-name", "bucket_coskeys": {"key": "value"}},
        "PUT",
        "/scalemgmt/v3/buckets/{bucket_name}/afmcos/setcoskeys",
    ),
    C(
        "v3.afmcos",
        "delete_cos_keys_api",
        {"bucket_name": "test-bucket-name"},
        "DELETE",
        "/scalemgmt/v3/buckets/{bucket_name}/afmcos/delcoskeys",
    ),
    C(
        "v3.afmcos",
        "configure_afmcos_api",
        {
            ...
            "fileset_config": {"key": "value"},
        },
        "PUT",
        "/scalemgmt/v3/filesystems/{filesystem}/filesets/{fileset}/afmcos/configure",
    ),
    C(
        "v3.afmcos",
        "delete_afmcos_objects_api",
        {
            "filesystem": "test-filesystem",
            "fileset": "test-fileset",
            "delete_objects": {"key": "value"},
        },
        "POST",
        "/scalemgmt/v3/filesystems/{filesystem}/filesets/{fileset}/afmcos/delete",
    ),
    C(
        "v3.afmcos",
        "download_afmcos_objects_api",
        {
            "filesystem": "test-filesystem",
            "fileset": "test-fileset",
            "download_objects": {"key": "value"},
        },
        "POST",
        "/scalemgmt/v3/filesystems/{filesystem}/filesets/{fileset}/afmcos/download",
    ),
    C(
        "v3.afmcos",
        "evict_afmcos_objects_api",
        {
            "filesystem": "test-filesystem",
            "fileset": "test-fileset",
            "evict_objects": {"key": "value"},
        },
        "POST",
        "/scalemgmt/v3/filesystems/{filesystem}/filesets/{fileset}/afmcos/evict",
    ),
    C(
        "v3.afmcos",
        "reconcile_afmcos_api",
        {
            "filesystem": "test-filesystem",
            "fileset": "test-fileset",
            "reconcile_objects": {"key": "value"},
        },
        "POST",
        "/scalemgmt/v3/filesystems/{filesystem}/filesets/{fileset}/afmcos/reconcile",
    ),
    C(
        "v3.afmcos",
        "upload_afmcos_objects_api",
        {
            "filesystem": "test-filesystem",
            "fileset": "test-fileset",
            "upload_objects": {"key": "value"},
        },
        "PUT",
        "/scalemgmt/v3/filesystems/{filesystem}/filesets/{fileset}/afmcos/upload",
    ),
    # --- v3/api_health ---
    ...
    C(
        ...
        "GET",
        "/scalemgmt/v3/apihealth/{node_name}",
    ),
    # --- v3/authorization ---
    C(
        "v3.authorization",
    ...
    C(
        ...
        {"action": "test-action", "resource": "test-resource", "user": "test-user"},
        "POST",
    ...
    C(
        ...
        {"name": "test-name"},
        "GET",
        "/scalemgmt/v3/authorization/domains/{name}",
    ),
    C(
        "v3.authorization",
        "update_rbac_domain_api",
        {"name": "test-name", "domain_data": {"key": "value"}},
        "PATCH",
        "/scalemgmt/v3/authorization/domains/{name}",
    ),
    C(
    ...
    C(
        ...
        {"name": "test-name"},
        "GET",
        "/scalemgmt/v3/config/admin/{name}",
    ),
    C(
        "v3.config",
    ...
    C(
        ...
        {"name": "test-name"},
        "GET",
        "/scalemgmt/v3/config/cluster/{name}",
    ),
    C(
        "v3.config",
    ...
    C(
        "v3.diagnostics",
        "get_node_version_api",
        {"node": "test-node"},
        "GET",
        "/scalemgmt/v3/nodes/{node}/diagnostics/version",
    ),
    # --- v3/filesets ---
    C(
        "v3.filesets",
        ...
        {"filesystem": "test-filesystem"},
        "GET",
        "/scalemgmt/v3/filesystems/{filesystem}/filesets",
    ),
    C(
        "v3.filesets",
        "create_fileset_api",
        {"filesystem": "test-filesystem", "fileset_data": {"key": "value"}},
        "POST",
        "/scalemgmt/v3/filesystems/{filesystem}/filesets",
    ),
    C(
        "v3.filesets",
        "get_fileset_api",
        {"filesystem": "test-filesystem", "fileset_name": "test-fileset-name"},
        "GET",
        "/scalemgmt/v3/filesystems/{filesystem}/filesets/{fileset_name}",
    ),
    C(
        "v3.filesets",
        "delete_fileset_api",
    ...
    C(
        ...
        {
            "filesystem": "test-filesystem",
            "fileset_name": "test-fileset-name",
            "fileset_data": {"key": "value"},
        },
        "PATCH",
        "/scalemgmt/v3/filesystems/{filesystem}/filesets/{fileset_name}",
    ),
    C(
        ...
        {"filesystem": "test-filesystem", "fileset_name": "test-fileset-name"},
        "GET",
        "/scalemgmt/v3/filesystems/{filesystem}/filesets/{fileset_name}/usage",
    ),
    C(
        "v3.filesets",
        "link_fileset_api",
        ...
        "POST",
        "/scalemgmt/v3/filesystems/{filesystem}/filesets/{fileset_name}:link",
    ),
    C(
        "v3.filesets",
        "unlink_fileset_api",
        {"filesystem": "test-filesystem", "fileset_name": "test-fileset-name"},
        "POST",
        "/scalemgmt/v3/filesystems/{filesystem}/filesets/{fileset_name}:unlink",
    ),
    C(
        "v3.filesets",
        ...
        {"filesystem": "test-filesystem", "fileset": "test-fileset"},
        "GET",
        "/scalemgmt/v3/filesystems/{filesystem}/filesets/{fileset}/snapshots",
    ),
    C(
        "v3.filesets",
    ...
    C(
        ...
        "GET",
        "/scalemgmt/v3/filesystems/{filesystem}/filesets/{fileset}/snapshots/{snapshot_name}",
    ),
    C(
        "v3.filesets",
    ...
    C(
        "v3.filesets",
        "batch_create_fileset_snapshots_api",
        {"filesystem": "test-filesystem", "snapshot_data": {"key": "value"}},
        "POST",
        "/scalemgmt/v3/filesystems/{filesystem}/filesets/snapshots:batchCreate",
    ),
    C(
        "v3.filesets",
        "batch_delete_fileset_snapshots_api",
        {"filesystem": "test-filesystem", "snapshot_data": {"key": "value"}},
        "POST",
        "/scalemgmt/v3/filesystems/{filesystem}/filesets/snapshots:batchDelete",
    ),
    # --- v3/filesystem_disks ---
    C(
        "v3.filesystem_disks",
        ...
        {"filesystem": "test-filesystem"},
        "GET",
        "/scalemgmt/v3/filesystems/{filesystem}/disks",
    ),
    C(
        "v3.filesystem_disks",
        "get_filesystem_disk_api",
        {"filesystem": "test-filesystem", "disk_name": "test-disk-name"},
        "GET",
        "/scalemgmt/v3/filesystems/{filesystem}/disks/{disk_name}",
    ),
    C(
        "v3.filesystem_disks",
    ...
    C(
        ...
        {"filesystem": "test-filesystem", "disk_name": "test-disk-name", "continue_on_error": True},
        "DELETE",
        "/scalemgmt/v3/filesystems/{filesystem}/disks/{disk_name}",
    ),
    C(
        ...
        {"filesystem": "test-filesystem", "disks_data": {"key": "value"}},
        "POST",
        "/scalemgmt/v3/filesystems/{filesystem}/disks:batchAdd",
    ),
    C(
        "v3.filesystem_disks",
        ...
        {"filesystem": "test-filesystem"},
        "POST",
        "/scalemgmt/v3/filesystems/{filesystem}/disks:batchDelete",
    ),
    C(
        "v3.filesystem_disks",
        ...
        {"filesystem": "test-filesystem"},
        "GET",
        "/scalemgmt/v3/filesystems/{filesystem}/disksquorum",
    ),
    # --- v3/filesystems ---
    ...
    C(
        ...
        {"filesystem": "test-filesystem"},
        "GET",
        "/scalemgmt/v3/filesystems/{filesystem}",
    ),
    C(
        "v3.filesystems",
        "create_filesystem_api",
        {"filesystem_data": {"key": "value"}},
        "POST",
    ...
    C(
        ...
        {"filesystem": "test-filesystem", "filesystem_data": {"key": "value"}},
        "PATCH",
        "/scalemgmt/v3/filesystems/{filesystem}",
    ),
    C(
    ...
    C(
        ...
        {"filesystem": "test-filesystem"},
        "GET",
        "/scalemgmt/v3/filesystems/{filesystem}:mount",
    ),
    C(
        "v3.filesystems",
        ...
        {"name": "test-name"},
        "POST",
        "/scalemgmt/v3/filesystems/{name}:mount",
    ),
    C(
        "v3.filesystems",
        ...
        {"name": "test-name"},
        "POST",
        "/scalemgmt/v3/filesystems/{name}:unmount",
    ),
    ...
    C(
        ...
        {"filesystem": "test-filesystem"},
        "POST",
        "/scalemgmt/v3/filesystems/{filesystem}:rebalance",
    ),
    C(
        "v3.filesystems",
        ...
        {"filesystem": "test-filesystem"},
        "POST",
        "/scalemgmt/v3/filesystems/{filesystem}:restripe",
    ),
    C(
        "v3.filesystems",
        "list_directory_api",
        {"filesystem": "test-filesystem", "dirpath": "test-dirpath"},
        "GET",
        "/scalemgmt/v3/filesystems/{filesystem}/directory/{dirpath}",
    ),
    C(
        "v3.filesystems",
        "stat_directory_api",
        {"filesystem": "test-filesystem", "dirpath": "test-dirpath"},
        "GET",
        "/scalemgmt/v3/filesystems/{filesystem}/directory/{dirpath}:stat",
    ),
    C(
        "v3.filesystems",
    ...
    C(
        ...
        {"filesystem": "test-filesystem", "manager_data": {"key": "value"}},
        "POST",
        "/scalemgmt/v3/filesystems/{filesystem}/manager",
    ),
    # --- v3/node_classes ---
    ...
    C(
        "v3.node_classes",
        "get_node_class_api",
        {"node_class": "test-node-class"},
        "GET",
        "/scalemgmt/v3/nodeclasses/{node_class}",
    ),
    C(
        "v3.node_classes",
        "create_node_class_api",
        {"nodeclass_data": {"key": "value"}},
        "POST",
    ...
    C(
        ...
        {"node_class": "test-node-class", "nodeclass_data": {"key": "value"}},
        "PATCH",
        "/scalemgmt/v3/nodeclasses/{node_class}",
    ),
    C(
    ...
    C(
        "v3.nsds",
        "get_nsd_api",
        {"nsd_name": "test-nsd-name"},
        "GET",
        "/scalemgmt/v3/nsds/{nsd_name}",
    ),
    C("v3.nsds", "create_nsd_api", {"nsd_data": {"key": "value"}}, "POST", "/scalemgmt/v3/nsds"),
    C(
        "v3.nsds",
        "update_nsd_api",
        {"nsd_name": "test-nsd-name", "nsd_data": {"key": "value"}},
        "PATCH",
        "/scalemgmt/v3/nsds/{nsd_name}",
    ),
    C(
    ...
    C(
        ...
        "GET",
        "/scalemgmt/v3/operations/{operation_id}",
    ),
    C(
        "v3.operations",
        ...
        {"operation_id": "test-operation-id"},
        "GET",
        "/scalemgmt/v3/operations/{operation_id}/output",
    ),
    C(
        "v3.operations",
        ...
        {"operation_id": "test-operation-id"},
        "POST",
        "/scalemgmt/v3/operations/{operation_id}:cancel",
    ),
    C(
        "v3.operations",
    ...
    C(
        ...
        {"filesystem": "test-filesystem"},
        "GET",
        "/scalemgmt/v3/filesystems/{filesystem}/policy",
    ),
    C(
        "v3.policies",
        "update_policy_api",
        {"filesystem": "test-filesystem", "policy": {"key": "value"}},
        "PATCH",
        "/scalemgmt/v3/filesystems/{filesystem}/policy",
    ),
    # --- v3/quotas ---
    C(
        ...
        {"filesystem": "test-filesystem"},
        "GET",
        "/scalemgmt/v3/filesystems/{filesystem}/quotas",
    ),
    C(
        "v3.quotas",
        "set_quota_api",
        {"filesystem": "test-filesystem", "quota_data": {"key": "value"}},
        "PUT",
        "/scalemgmt/v3/filesystems/{filesystem}/quotas",
    ),
    C(
    ...
    C(
        ...
        {"filesystem": "test-filesystem", "config_data": {"key": "value"}},
        "POST",
        "/scalemgmt/v3/filesystems/{filesystem}/quotas/config",
    ),
    C(
        "v3.quotas",
        ...
        {"filesystem": "test-filesystem", "fileset": "test-fileset"},
        "GET",
        "/scalemgmt/v3/filesystems/{filesystem}/filesets/{fileset}/quotas",
    ),
    C(
        "v3.quotas",
    ...
    C(
        ...
        {"name": "test-name"},
        "GET",
        "/scalemgmt/v3/clusters/remote/{name}",
    ),
    C(
        "v3.remote_clusters",
        "add_remote_cluster_api",
        {"remote_cluster": {"key": "value"}},
        "POST",
    ...
    C(
        ...
        {"name": "test-name", "remote_cluster": {"key": "value"}},
        "PATCH",
        "/scalemgmt/v3/clusters/remote/{name}",
    ),
    C(
    ...
    C(
        ...
        {"name": "test-name"},
        "DELETE",
        "/scalemgmt/v3/clusters/remote/authorized/{name}",
    ),
    C(
        "v3.remote_clusters",
        ...
        {"name": "test-name"},
        "POST",
        "/scalemgmt/v3/clusters/remote/{name}/refresh",
    ),
    ...
    C(
        ...
        {"filesystem": "test-filesystem", "filesystem_data": {"key": "value"}},
        "PATCH",
        "/scalemgmt/v3/filesystems/remote/{filesystem}",
    ),
    C(
        "v3.remote_filesystems",
    ...
    C(
        ...
        {"filesystem": "test-filesystem"},
        "GET",
        "/scalemgmt/v3/filesystems/{filesystem}/snapshots",
    ),
    C(
        "v3.snapshots",
        "create_snapshot_api",
    ...
    C(
        "v3.snapshots",
        "get_snapshot_api",
        {"filesystem": "test-filesystem", "snapshot_name": "test-snapshot-name"},
        "GET",
    ...
    C(
        "v3.snapshots",
        "batch_delete_snapshots_api",
        {"filesystem": "test-filesystem", "snapshot_data": {"key": "value"}},
        "POST",
        "/scalemgmt/v3/filesystems/{filesystem}/snapshots:batchDelete",
    ),
    C(
        "v3.snapshots",
        ...
        {"filesystem": "test-filesystem"},
        "GET",
        "/scalemgmt/v3/filesystems/{filesystem}/snapshots:snapdir",
    ),
    # --- v3/storage_pools ---
    C(
        "v3.storage_pools",
        ...
        {"filesystem": "test-filesystem"},
        "GET",
        "/scalemgmt/v3/filesystems/{filesystem}/storagepools",
    ),
    C(
        "v3.storage_pools",
        "get_storage_pool_api",
        {"filesystem": "test-filesystem", "pool_name": "test-pool-name"},
        "GET",
        "/scalemgmt/v3/filesystems/{filesystem}/storagepools/{pool_name}",
    ),
    C(
        "v3.storage_pools",
    ...
    C(
        ...
        {"device": "test-device"},
        "GET",
        "/scalemgmt/v3/troubleshooting/persistentReserve/{device}/keys",
    ),
    C(
        "v3.troubleshooting",
