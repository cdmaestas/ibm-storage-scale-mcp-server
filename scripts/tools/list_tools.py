...
For HTTP, start the server first:
  scale-mcp-server --transport http --port 8000
    ...
    parser.add_argument(
        "--host", default="127.0.0.1", help="Server host address for HTTP transport (default: 127.0.0.1)"
    )
    parser.add_argument("--port", type=int, default=8000, help="Server port for HTTP transport (default: 8000)")
    parser.add_argument(
        "--detailed", action="store_true", help="Show detailed information including full descriptions and parameters"
    )
