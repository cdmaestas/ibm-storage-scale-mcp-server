...
async def get_afm_state(
    ...
    Args:
        ...
        domain: Domain to be authorized against (default 'StorageScaleDomain')
    """
    await ctx.info(f"Tool called: get_afm_state with filesystem={filesystem}, fileset={fileset}")
    try:
        return await get_afm_state_api(filesystem=filesystem, fileset=fileset, domain=domain)
    except Exception as e:
...
async def check_afm_dirty(
    ...
    Args:
        ...
        domain: Domain to be authorized against (default 'StorageScaleDomain')
    """
    await ctx.info(f"Tool called: check_afm_dirty with filesystem={filesystem}, fileset={fileset}")
    try:
...
async def check_afm_uncached(
    ...
    Args:
        ...
        domain: Domain to be authorized against (default 'StorageScaleDomain')
    """
    await ctx.info(f"Tool called: check_afm_uncached with filesystem={filesystem}, fileset={fileset}")
    try:
...
async def flush_afm_queue(
    ...
    Args:
        ...
        domain: Domain to be authorized against (default 'StorageScaleDomain')
    """
    await ctx.info(f"Tool called: flush_afm_queue with filesystem={filesystem}, fileset={fileset}")
    try:
        return await flush_afm_queue_api(filesystem=filesystem, fileset=fileset, domain=domain)
    except Exception as e:
...
async def resume_afm_requeued(
    ...
    Args:
        ...
        domain: Domain to be authorized against (default 'StorageScaleDomain')
    """
    await ctx.info(f"Tool called: resume_afm_requeued with filesystem={filesystem}, fileset={fileset}")
    try:
        return await resume_afm_requeued_api(filesystem=filesystem, fileset=fileset, domain=domain)
    except Exception as e:
...
async def resync_afm_fileset(
    ...
    Args:
        ...
        domain: Domain to be authorized against (default 'StorageScaleDomain')
    """
    await ctx.info(f"Tool called: resync_afm_fileset with filesystem={filesystem}, fileset={fileset}")
    try:
        return await resync_afm_fileset_api(filesystem=filesystem, fileset=fileset, domain=domain)
    except Exception as e:
...
async def start_afm_fileset(
    ...
    Args:
        ...
        domain: Domain to be authorized against (default 'StorageScaleDomain')
    """
    await ctx.info(f"Tool called: start_afm_fileset with filesystem={filesystem}, fileset={fileset}")
    try:
        return await start_afm_fileset_api(filesystem=filesystem, fileset=fileset, domain=domain)
    except Exception as e:
...
async def stop_afm_fileset(
    ...
    Args:
        ...
        domain: Domain to be authorized against (default 'StorageScaleDomain')
    """
    await ctx.info(f"Tool called: stop_afm_fileset with filesystem={filesystem}, fileset={fileset}")
    try:
        return await stop_afm_fileset_api(filesystem=filesystem, fileset=fileset, domain=domain)
    except Exception as e:
...
async def reset_afm_local(
    ...
    Args:
        ...
        domain: Domain to be authorized against (default 'StorageScaleDomain')
    """
    await ctx.info(f"Tool called: reset_afm_local with filesystem={filesystem}, fileset={fileset}")
    try:
...
async def set_afm_local(
    ...
    Args:
        ...
        domain: Domain to be authorized against (default 'StorageScaleDomain')
    """
    await ctx.info(f"Tool called: set_afm_local with filesystem={filesystem}, fileset={fileset}")
    try:
